...
public class Popup_GetCoin : BasePopup
{
    ...
    /// <returns></returns>
    public static Popup_GetCoin Show(string t, string d, WindowDelegate btnCallBack = null, WindowOpen callBack = null)
    {
        GameObject o = Resources.Load("Prefabs/Common/Popup_GetCoin") as GameObject;
        GameObject prefab = Instantiate(o);
        prefab.transform.SetParent(GameObject.Find("PopupCanvas").transform, false);
        Popup_GetCoin script = prefab.GetComponent<Popup_GetCoin>();
