...
public class Popup_YesNo : BasePopup
{
    public Text title = null;

    public Text description = null;

    public Text yesBtn = null;
    ...
    /// <returns></returns>
    public static Popup_YesNo Show(string t, string d, string yes = "Yes", string no = "No", WindowDelegate btnCallBack = null, WindowOpen callBack = null)
    {
        ...
        Popup_YesNo script = prefab.GetComponent<Popup_YesNo>();
